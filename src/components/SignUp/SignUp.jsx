    ...
    <div className="flex flex-row h-screen bg-white	">
      <div className="w-2/4 self-center text-center">
        ...
        <div className="flex flex-row justify-center mb-3">
          <div>
            <input
              className="bg-inputForm font-light rounded-lg text-sm p-2 w-40  relative right-1 focus:outline-none active:outline-none"
              type="text"
            ...
            />
            <input
              className="bg-inputForm font-light rounded-lg text-sm p-2 w-40 relative left-1 focus:outline-none active:outline-none"
              type="text"
              ...
              onChange={handleChange}
            />
            <div className="text-red-400 relative text-xs">
        ...
        <div className="flex flex-col text-center items-center">
          <input
            className="bg-inputForm  font-light w-2/4 px-6 p-2 rounded-lg mb-3 text-sm focus:outline-none active:outline-none"
            type="mail"
          ...
          />
          <div className="text-red-400 relative bottom-2.5 text-xs">
            {inputInvalidEmail && focusedEmailInput ? "Email invalid" : ""}
          </div>
          <div className="flex justify-between items-center px-4 bg-inputForm font-light w-2/4 rounded-lg text-sm focus:outline-none active:outline-none">
            <input
              className="bg-inputForm font-light w-2/4 p-2 rounded-lg text-sm focus:outline-none active:outline-none"
          ...
          <div className="text-red-400 relative top-0.5 text-xs text-center w-80">
            {inputInvalidPassword && focusedPasswordInput ? (
              <div>
                This field is <span className="font-bold">required</span>. It
                must have at least{" "}
                <span className="font-bold"> 1 lowercase </span>letter,{" "}
                <span className="font-bold"> 1 uppercase</span> letter,{" "}
                <span className="font-bold">1 number</span> ,{" "}
                <span className="font-bold">no spaces</span> and a minimum of{" "}
        ...
        >
          <div className="flex justify-center w-60 rounded-2xl p-2 bg-white mt-2 drop-shadow-xl">
            ...
            <h2 className="m-1.5 font-semibold text-google">
