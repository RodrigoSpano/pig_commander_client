...
const HeaderDetailEs = ({ user }) => {
  return (
    ...
    >
      ...
      <section className="grid grid-cols-2 gap-4 ml-4">
        <div className={"border-solid border-l-4  p-2 border-lightPink"}>
          <h2 className="text-lg font-semibold">Nombre</h2>
          <h3>{user.name}</h3>
        </div>
        <div className={"border-solid border-l-4 border-lightPink p-2 ml-2"}>
        ...
        <div
          className={"border-solid border-l-4 p-2 capitalize border-lightPink ml-2"}
        >
