    ...
    Swal.fire({
      ...
      <div class= 'grid  grid-cols-4 grid-rows-5 gap-5 m-2'>
        ...
        <div class='col-span-4 p-4 rounded-lg border text-center m-2 border-red-700 '> 
          <h1 class='text-strongPink font-bold'>DETALLE DE ${transaction.type.toUpperCase() == 'INCOME' ? 'INGRESO' : 'GASTO'}</h1>
          <p class='text-sm text-gray-400 font-bold'>Fecha: ${transaction.createdAt.substring(0, 10)}</p>
        </div>
