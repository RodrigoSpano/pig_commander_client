        ...
        <div className="flex flex-row h-screen bg-white select-none">
            <div className="w-2/4 self-center text-center">
                ...
                <div className="flex flex-col text-center items-center">
                    ...
                    <input className="bg-inputForm placeholder-black font-light w-2/4 p-1.5 rounded-lg text-sm focus:outline-none active:outline-none" type={showPassword ? "text" : "password"} name="password" value={userLogin.password} placeholder="Password" autoComplete="off" onChange={handleChange} min="8" required onFocus={allowPasswordErrorMessage} />
                    
                    {/* <button
                        className="flex items-center ml-2 focus:outline-none bg-black"
                ...
                <h3 className="text-gray-500 mt-5 cursor-pointer" onClick={togglePasswordVisibility}>Don't have an account?</h3>
                <Link href="/signup">
