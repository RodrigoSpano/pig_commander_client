    ...
    <div className="flex flex-col items-center h-3">
      ...
      <div className="flex flex-row mt-2 h">
        <div className="flex flex-col mr-2.5">
          <p className="text-boldGray text-lg font-light">Name</p>
          <input
            className="bg-lightGray  placeholder-black font-light rounded-lg text-sm p-1.5 w-40 relative focus:outline-none active:outline-none"
            autoComplete="off"
            type="text"
            name="name"
        ...
        <div className="flex flex-col">
          <p className="text-boldGray text-lg font-light">Amount</p>
          <input
            className="bg-lightGray placeholder-black font-light rounded-lg text-sm p-1.5 w-40 relative focus:outline-none active:outline-none"
            autoComplete="off"
            type="number"
      ...
      <p className="text-red-400 relative mt-2 text-xs">
      ...
      <div className="flex flex-row m-2.5 mt-5">
        <div className="flex flex-col mr-2.5 ">
          <label className="text-boldGray text-lg font-light">Method:</label>
          <select
            className="text-sm w-40 bg-lightGray font-light rounded-lg p-1.5"
            name="method_id"
            id="selects"
            onChange={handleChange}
        ...
        <div className="flex flex-col ">
          <label className="text-boldGray text-lg font-light">
            Categories:
          </label>
          <select
            className="text-sm w-40 bg-lightGray font-light rounded-lg p-1.5 capitalize"
            name="category_id"
            id="selects"
      ...
      <div className="flex flex-row mt-5">
        ...
        <input
          ...
          disabled={!automatized && true}
          onChange={handleAutoChange}
        />
        <select
          defaultValue={"expense"}
          name="type"
          className="text-sm w-26 bg-lightGray font-light rounded-lg p-1.5 ml-2"
          disabled={!automatized && true}
          onChange={handleAutoChange}
        >
