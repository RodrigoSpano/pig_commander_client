...
import PersonalInformationEs from "./Subcomponents copy/Personal Information/PersonalInformationEs";
import ProfileImageEs from "./Subcomponents copy/ProfileImageEs";
import AppSettingsEs from "./Subcomponents copy/AppSettingsEs";

function ProfileComponentEs() {
        ...
        <main className="m-6 select-none">
          ...
          <section className="flex flex-col space-y-4 sm:space-y-4">
            <div className="flex flex-col-reverse lg:flex-row space-y-4 sm:space-y-0 md:space-y-4 md:space-x-4 lg:space-y-0 xl:space-y-4">
              <PersonalInformationEs className="w-full lg:w-1/2 xl:w-2/3" />
              <ProfileImageEs className="w-full lg:w-1/2 xl:w-1/3" />
            </div>
